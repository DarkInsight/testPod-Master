...
// ZFHaversine
#define COCOAPODS_POD_AVAILABLE_ZFHaversine
#define COCOAPODS_VERSION_MAJOR_ZFHaversine 0
#define COCOAPODS_VERSION_MINOR_ZFHaversine 3
#define COCOAPODS_VERSION_PATCH_ZFHaversine 0
